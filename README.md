      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=22547&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/playwright-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_nodejs26" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi global install playwright
```
...
It is possible to list all of the versions of `playwright` available on your platform:
...
```
pixi search playwright --channel conda-forge
```
